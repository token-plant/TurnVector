...
mod tests {
    ...
    fn registration_core(capacity: u32) -> Core<4> {
        ...
        let support = CoreSupport::try_new(SupportLedgerGeneration::new(1).unwrap(), capacities, 1, starts, LifecycleReserveMaxima([1; 5]), 4, 8).unwrap();
    ...
    fn describe_model_starts_only_after_support_charge() {
        ...
        assert_eq!(transition.work(), HotPathWorkWitness::new([3, 448, 0, 1, 33]));
